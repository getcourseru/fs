...
const { lessonDuration, teacherType, packageType, courseType, lessonCount, folder } = PARAMS

if (lessonDuration && teacherType && packageType && courseType && courseType && folder) {
	fetch(`https://getcourseru.github.io/fs/${folder}/${folder.replace('class', 'ceny')}.json`)
